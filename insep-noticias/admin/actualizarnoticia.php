     ...
     <!-- Navigation -->
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <form class="form-horizontal" method="post" action="update2.php" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        <label for="disabledinput" class="col-sm-2 control-label">Descripciòn</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" name="descripcion" id="descripcion" value="<?php echo $res[2]; ?>"  required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="noticia" class="col-sm-2 control-label">Noticia</label>
                        <div class="col-sm-8">
                            <textarea name="noticia"  id="noticia"><?php echo $res[6]; ?></textarea>
                        </div>
                    </div>
