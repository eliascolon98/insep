...
<body>
	...
	<div class="col-inv">
		<div class=" serv-4">
			...
			<h3 class="txt-serv txt-inv-t dis-n">investigaciones</h3>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h2 class="modal-title" id="" style="font-weight: 700;">Solicitud de investigación</h2>
				...
				<form id="form_cot">
						...
						<button type="button" class="btn btn-primary btn-calcular">Calcular monto</button>
					</form>
				</div>
